...
if __name__ == "__main__":
    ...
    citation_count_tf_model = cem_test("novelty_10perc", "topic_familiarity", combined_papers_scaled, [predictor_var] + ["new_tie_rate"] + ["topic_distr{}".format(i) for i in range(1,20)])
